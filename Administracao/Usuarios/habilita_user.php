...
<script>
    function excluir() {
        var resultado = confirm("Você realmente deseja habilitar o usuario?");
        if (resultado == true) {
...
<div class="border-bottom">
    <h2 class="text-center">Habilitar Usuario</h2>
</div>
...
<?php
    ...
    if($linha['id']==$_GET['id']){
?>
    <form class="row g-3" id="form1" action="./Administracao/Usuarios/pro_hab_user.php" method="POST">
    ...
    <br>
    <div class="col-md-12">
            <button onclick="excluir()" class="btn btn-success"><i class="far fa-check-circle fa-2x"></i></button>
        </div>
    <?php   }
        }
    ?>
