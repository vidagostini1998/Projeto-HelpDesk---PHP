...
<body>
    ...
    <div class="container-fluid">
        ...
        <form class="row g-3" action="./HelpDesk/adm/alter/pro_reabrir_equip.php" method="POST">
            <div class="col-md-1">
            ...
            <div class="col-12">
                ...
                <button title="Reabrir Chamado" class="btn btn-success"><i class="far fa-folder-open fa-2x"></i></a>
