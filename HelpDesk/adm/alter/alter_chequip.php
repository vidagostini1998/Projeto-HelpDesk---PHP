...
<body>
    ...
    <div class="container-fluid">
        ...
        <form class="row g-3">
            ...
            <div class="col-md-3">
                <label for="situ" class="form-label">Situação</label>
                <select required id="situ" disabled name="situ" class="form-select">
                    ...
                    <?php 
                        ...
                        else if($linha['resolvido'] == 0){
                            $select1 = "selected";
                           
                        }
                        echo '<option value="1" '.$select.'>Resolvido</option>';
                        echo '<option value="0" '.$select1.'>Em aberto</option>';
        ...
        <?php
            ...
            <div id="txt"></div>
            <div class="col-12">
                <a title="Alterar Chamado" class="btn btn-secondary" href="?page=alterar_equip_adm&id=<?php echo $linha['id']; ?>"><i class="far fa-edit fa-2x"></i></a>
                <?php

                    if($linha['resolvido'] == 2){
                        ?>
                        <a title="Reabrir Chamado" class="btn btn-success" href="?page=reabrir_equip&id=<?php echo $linha['id'];  ?>"><i class="far fa-folder-open fa-2x"></i></a>
                        <?php
                    }
                    else{
                        ?>
                        <a title="Resolver Chamado" class="btn btn-success" href="?page=re_equip_adm&id=<?php echo $linha['id']; ?>"> <i class="far fa-check-circle fa-2x"></i></a>
                        <?php
                    }
