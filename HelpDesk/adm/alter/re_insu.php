...
<body>
    <header>
        ...
        <div class="border-bottom">
            <h2 class="text-center">Resolver Chamado</h2>
        </div>
...
<div class="container-fluid">
    <?php
        ...
        if($linha['id']==$_GET['id']){
    ?>
    <form class="row g-3" action="./HelpDesk/adm/alter/pro_re_insu.php" method="POST">
        <div class="col-1">
        ...
        <div class="col-md-6">
            ...
            <textarea required class="form-control" id="solucao" name="solucao" placeholder="Solução"><?php 
                echo $linha['solucao']; ?></textarea>
        </div>
        ...
        <div class="col-md-2">
            ...
            <input type="text" id="nome_reso" name="nome_reso" class="form-control text-center" value="<?php echo $linha['nome_reso'];?>"
                readonly>
        </div>
        <div id="txt"></div>
        <div class="col-md-12">
