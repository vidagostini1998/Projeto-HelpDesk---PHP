...
<body>
    <header>
        ...
        <div class="border-bottom">
            <h2 class="text-center">Reabrir Chamado</h2>
        </div>
    ...
    <div class="container-fluid">
        ...
        if($linha['id']==$_GET['id']){
    ?>
        <form class="row g-3" action="./HelpDesk/adm/alter/pro_reabrir_insu.php" method="POST">
            <div class="col-md-1">
                <label for="id" class="form-label">ID</label>
                <input type="text" name="id" class="form-control text-center" id="id" readonly
                    value="<?php echo $linha['id'] ?>" readonly>

            </div>
            <div class="col-md-3">
                <label for="data_ab" class="form-label">Data Abertura</label>
                <input readonly type="date" required name="data_ab" s class="form-control text-center" id="data_ab"
                    value="<?php echo $linha['data_chamado'] ?>">
            </div>

            <div class="col-md-3">
                <label for="data_conclu" class="form-label">Data de Conclusão</label>
                <input readonly type="date" name="data_conclu" class="form-control text-center" id="data_conclu"
                    value="<?php echo $linha['data_conclusão'] ?>">
            </div>

            <div class="col-md-2">
                <label for="solicitante" class="form-label">ID Solicitante</label>
                <input readonly type="text" name="solicitante" class="form-control text-center" id="solicitante" readonly
                    value="<?php echo $linha['solicitante'] ?>">
            </div>
            <div class="col-md-2">
                <label for="soli" class="form-label"> Solicitante </label>
                <input readonly type="text" disabled id="soli" class="form-control text-center"
                    value="<?php echo $linha['nome'] ?>">
            </div>

            <div class="col-md-6">
                <label for="descricao" class="form-label">Descrição</label>
                <textarea readonly required name="descricao" class="form-control"
                    id="descricao"><?php echo $linha['descricao'] ?></textarea>
            </div>

            <div class="col-md-6">
                <label for="inputAddress2" class="form-label">Solução</label>
                <textarea readonly required class="form-control" id="solucao" name="solucao"
                    placeholder="Solução"> <?php echo $linha['solucao'] ?> </textarea>
            </div>

            <div class="col-md-6">
                <label for="obs" class="form-label">OBS</label>
                <textarea readonly name="obs" class="form-control" id="obs"
                    placeholder="OBS"><?php echo $linha['obs'] ?></textarea>
            </div>

            <div class="col-md-3">
                <label for="categoria" class="form-label">Categoria</label>
                <select disabled required id="categoria" name="categoria" class="form-select">
            ...
            <div class="col-md-3">
                ...
                <select disabled required id="patrimonio" name="patrimonio" class="form-select"
            ...
            <div class="col-md-3">
                ...
                <select disabled required id="local" name="local" class="form-select">
            ...
            <div class="col-md-3">
                ...
                <select disabled required id="filial" name="filial" class="form-select">
                    <option>Selecione</option>
                    <?php 
            ...
            <div id="txt"></div>
            <div class="col-md-12">
                <button type="submit" class="btn btn-success"><i class="far fa-folder-open fa-2x"></i></button>
            </div>
        </form>
        <?php   }
        }
