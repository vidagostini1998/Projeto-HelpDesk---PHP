...
$query = "UPDATE chamados_patrimonio SET resolvido = '0' WHERE id = '$id'";
...
if(!$result){
	...
	$query2 ="INSERT INTO atualizacao(data,descricao,soli,id_equip) VALUES ('$data','Reaberto Chamado','$id_soli','$id');";
	...
	echo "<script>location='../../../index.php?page=error&erro=".$error."&ip=".$_SERVER['REMOTE_ADDR']."&url=".$url."';</script>";	
		...
		$mensagem = "REABERTO CHAMADO EQUIPAMENTO ID Nº ".$id;
