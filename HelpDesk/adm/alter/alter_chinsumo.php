...
<body>
    ...
    <div class="container-fluid">
        ...
        if($linha['id']==$_GET['id']){
    ?>
        <form class="row g-3" action="./HelpDesk/adm/alter/pro_alterchinsu.php" method="POST">
            <div class="col-md-1">
            ...
            <div class="col-md-3">
                ...
                <input type="date" name="data_conclu" class="form-control text-center" id="data_conclu"
            ...
            <div class="col-md-6">
                ...
                <textarea required class="form-control" id="solucao" name="solucao"
