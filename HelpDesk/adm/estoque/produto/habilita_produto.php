...
<script>
    function excluir() {
        var resultado = confirm("Você realmente deseja Habilitar o produto?");
        if (resultado == true) {
...
<div class="container-fluid border-top border-bottom border-1 border-primary borda">
    ...
    <?php
        ...
        ?>
    <form id="form1" class="row g-3" action="./HelpDesk/adm/estoque/produto/pro_hab_produto.php" method="POST">
