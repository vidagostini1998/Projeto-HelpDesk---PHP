...
$query = "UPDATE produtos SET status = 1 WHERE id_produto = '$id'";
...
if(!$result){
	...
	$mensagem = "HABILLITADO PRODUTO ID Nº ".$id;
	$login = $_SESSION['UsuarioNome'];
	salvaLog($mensagem,$login);
	echo "<script>
	alert('Habilitado com sucesso'); location= '../../../../index.php?page=produto';
	</script>";
}
