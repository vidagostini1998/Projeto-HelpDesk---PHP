...
<?php
        ...
        ?>
    <form class="row g-3" action="./HelpDesk/adm/estoque/movimentacao/pro_alter_entrada.php" method="POST">
    <input type="hidden" name="id" id="id" value="<?php echo $_GET['id'];?>">
        ...
        <div class="col-md-12">
            ...
            <a href="?page=exclui_entrada&id=<?php echo $linha['id_entrada'] ?>" class="btn btn-danger"><i class="fas fa-minus-circle fa-2x"></i></a>
        </div>
    </form>
    <?php   }
        }
