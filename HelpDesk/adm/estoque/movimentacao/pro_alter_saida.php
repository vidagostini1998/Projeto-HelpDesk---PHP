...
$query = "UPDATE saida SET produto = '$produto', quantidade = '$quantidade', data_saida = '$data', id_adc = '$id_adc', local = '$local', filial = '$filial' WHERE id_saida = '$id'";
...
if(!$result){
	...
	$mensagem = "ALTERADO SAIDA ESTOQUE PRODUTO ID Nº".$produto;
