...
$query = "DELETE FROM manutencao WHERE id_manut = '$id'";
...
if(!$result){
	...
	$mensagem = "EXCLUIU MANUTENCAO ID Nº ".$id;
	$login = $_SESSION['UsuarioNome'];
	salvaLog($mensagem,$login);
	echo "<script>
	alert('Excluido com sucesso'); location= '../../../index.php?page=consulta_manutencao';
	</script>";
}
