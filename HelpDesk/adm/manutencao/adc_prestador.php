...
<div class="container-fluid border-top border-bottom border-1 border-primary borda">
    <form class="row g-3" action="./HelpDesk/adm/manutencao/pro_adc_prestador.php" method="POST">
        <div class="col-md-2">
        ...
        <div class="col-md-6">
            ...
            <input required name="nome" class="form-control" id="nome" placeholder="Prestador"></input>
        </div>
        <div class="col-md-12">
