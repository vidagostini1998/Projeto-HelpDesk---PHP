...
$query = "UPDATE prestador SET nome_prestador = '$nome', data_adc = '$data_adc' WHERE id_prestador = '$id'";
...
if(!$result){
	...
	$mensagem = "ALTERADO PRESTADOR ID N° ".$id;
	$login = $_SESSION['UsuarioNome'];
	salvaLog($mensagem,$login);
	echo "<script>
	alert('Alterado com sucesso'); location= '../../../index.php?page=prestador';
	</script>";
}
