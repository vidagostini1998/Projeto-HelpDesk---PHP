...
$query = "UPDATE categoria_equi SET nome_cate = '$nome_cate', data_cad = '$data_inclu',id_soli = '$id_soli'  WHERE id_cate = '$id'";
...
if(!$result){
	...
	$mensagem = "ALTERAR CATEGORIA EQUIPAMENTO ID Nº ".$id;
