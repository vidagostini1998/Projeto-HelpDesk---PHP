...
<div class="px-3 py-2 border-bottom mb-3">
    <div class="text-end log">
        <a href="?page=editar_chequip&id=<?php echo $_GET['id'];?>" class="btn btn-primary"><i class="fas fa-arrow-circle-left"></i></a>
    </div>
</div>
</header>
...
<div class="container-fluid">
    ...
    <form class="row g-3" action="./HelpDesk/alter/pro_atua_equip.php" method="POST">
