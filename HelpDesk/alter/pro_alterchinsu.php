...
$query = "UPDATE chamados_insumos SET data_chamado = '$data_inclu', solicitante = '$id_soli', descricao = '$descricao', solucao = '$solucao', obs = '$obs', categoria = '$categoria', patrimonio = '$patrimonio', local = '$local', filial = '$filial', medida = '$medida', quantidade = '$quantidade' WHERE id = '$id'";
...
if(!$result){
	...
	echo "<script>
	alert('Alterado com sucesso'); location='../../index.php?page=inicio_helpdesk';
	</script>";
}
