...
$query = "UPDATE chamados_insumos SET data_chamado = '$data_inclu', data_conclusão = '$data_conclu', solicitante = '$id_soli', descricao = '$descricao', solucao = '$solucao', obs = '$obs', categoria = '$categoria', patrimonio = '$patrimonio', local = '$local', id_reso = '$id_reso', resolvido = 1, nome_reso = '$nome_reso', filial = '$filial', medida = '$medida', quantidade = '$quantidade'  WHERE id = '$id'";
...
if(!$result){
	...
	$query2 ="INSERT INTO atualizacao(data,descricao,soli,id_insu) VALUES ('$data','Chamado em espera para resolução','$id_soli','$id');";
	...
	$mensagem = "CHAMADO INSUMO EM ESPERA DE RESOLUÇÃO ID Nº ".$id;
