...
$query = "UPDATE chamados_patrimonio SET data_chamado = '$data_inclu', solicitante = '$id_soli', problema = '$problema', solucao = '$solucao', obs = '$obs', categoria = '$categoria', patrimonio = '$patrimonio', local = '$local', filial = '$filial' WHERE id = '$id'";
