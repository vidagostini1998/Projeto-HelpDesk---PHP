...
?>
    <form class="row g-3" action="./HelpDesk/alter/pro_filial.php" method="POST">
        ...
        <div class="col-md-6">
            ...
            <input name="nome_filial" required class="form-control" id="nome_filial"
                value="<?php echo $linha['nome_filial'];?>"></input>
        </div>
        <div class="col-md-12">
