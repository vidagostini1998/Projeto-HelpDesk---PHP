...
$query = "INSERT INTO atualizacao(data, descricao, soli, id_equip) VALUES ('$data_inclu', '$atualizacao', '$id_soli', '$id')";
...
if(!$result){
	...
	$mensagem = "ADC ATUALIZAÇÃO CHAMADO EQUIPAMENTO ID Nº ".$id;
	$login = $_SESSION['UsuarioNome'];
	salvaLog($mensagem,$login);
	echo "<script>
	alert('Alterado com sucesso'); location='../../index.php?page=editar_chequip&id=".$id."';
	</script>";
}
