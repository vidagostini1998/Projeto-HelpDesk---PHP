...
<div class="container-fluid">
    ...
    <form class="row g-3">
        ...
        <div id="txt"></div>
        <div class="col-12">
            <a class="btn btn-secondary" href="?page=alter_chinsumo&id=<?php echo $linha['id']; ?>"><i class="far fa-edit fa-2x"></i></a>
            <?php if($_SESSION['UsuarioNivel'] == 1){?>
            <a class="btn btn-info" href="?page=atualiza_insu&id=<?php echo $linha['id'];?>"><i class="far fa-comment fa-2x"></i></a>
            <a class="btn btn-success" href="?page=resolver_chinsumo&id=<?php echo $linha['id'];?>"><i class="far fa-check-circle fa-2x"></i></a>
            <?php }
