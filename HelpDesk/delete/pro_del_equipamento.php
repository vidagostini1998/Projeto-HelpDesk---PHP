...
$query = "DELETE FROM categoria_equi WHERE id_cate = '$id'";
...
if(!$result){
	...
	$mensagem = "EXCLUIU CATEGORIA EQUIPAMENTO ID Nº ".$id;
	$login = $_SESSION['UsuarioNome'];
	salvaLog($mensagem,$login);
	echo "<script>
	alert('Excluido com sucesso'); location='../../index.php?page=consulta_categoria';
	</script>";
}
