...
<div class="container-fluid">
    <?php
        ...
        if($linha['id_cate']==$_GET['id']){
        ?>
    <form class="row g-3" id="form1" action="./HelpDesk/delete/pro_del_equipamento.php" method="POST">
        <input type="hidden" name="id" value="<?php echo $linha['id_cate']; ?>">
        <div class="col-md-2">
            ...
            <input type="date" name="data_ab" class="form-control text-center" id="data_ab"
                value="<?php echo $linha['data_cad']; ?>" readonly>
        </div>
        ...
        <div class="col-md-6">
            ...
            <input name="nome_cate" required class="form-control" id="nome_cate"
                value="<?php echo $linha['nome_cate'];?>" readonly></input>
        </div>
