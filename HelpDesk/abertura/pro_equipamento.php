...
$query = "INSERT INTO chamados_patrimonio(data_chamado, solicitante, problema, obs, categoria, patrimonio, local, filial) VALUES ('$data_abertura', '$id_soli', '$problema', '$obs', '$categoria','$patrimonio', '$local', '$filial')";
...
if(!$result){	
	...
	$mensagem = "ADC CHAMADO EQUIPAMENTO";
