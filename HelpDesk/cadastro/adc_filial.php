...
<div class="border-bottom">
    <h2 class="text-center">Cadastro de Filial</h2>
</div>
...
<div class="container-fluid border-top border-bottom border-1 border-primary borda">
    <form class="row g-3" action="./HelpDesk/cadastro/cad_filial.php" method="POST">
        <div class="col-md-2">
        ...
        <div class="col-md-6">
            <label for="local" class="form-label">Nome Filial</label>
            <input required name="filial" class="form-control" id="filial" placeholder="Nome Filial"></input>
        </div>
        <div class="col-md-12">
