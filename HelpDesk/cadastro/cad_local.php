...
$query = "INSERT INTO local(nome_local, data_adc, id_soli) VALUES ('$nome_local', '$data_inclu', '$id_soli')";
...
if(!$result){
	...
	echo "<script>
	alert('Adicionado com sucesso'); location= '../../index.php?page=consulta_local';
	</script>";
}
